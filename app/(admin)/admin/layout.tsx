      ...
      <div className="flex h-screen overflow-hidden">
        ...
        `}>
          ...
          <nav className="flex-1 overflow-y-auto p-4 space-y-1">
            <NavItem href="/admin" icon="dashboard" label="Dashboard" isActive={pathname === '/admin'} />
            <NavItem href="/admin/profile" icon="person" label="Profile & Hero" isActive={pathname.startsWith('/admin/profile')} />
            <NavItem href="/admin/projects" icon="dataset" label="Projects" isActive={pathname.startsWith('/admin/projects')} />
            <NavItem href="/admin/tech" icon="code" label="Tech Stack" isActive={pathname.startsWith('/admin/tech')} />
            <NavItem href="/admin/about" icon="info" label="About Page" isActive={pathname.startsWith('/admin/about')} />
          </nav>
