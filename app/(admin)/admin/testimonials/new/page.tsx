			...
			<form onSubmit={handleSubmit} className="space-y-6">
				<div className="bg-glass-bg border border-glass-border rounded-2xl p-6 lg:p-8 space-y-6">
					...
					<div>
						...
						<textarea
							...
							rows={4}
							className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-primary/50 transition-colors"
							placeholder="Type the full review here..."
							required></textarea>
					</div>
				...
				<div className="flexjustify-end">
					<button
						type="submit"
						disabled={loading}
						className={`px-8 py-4 rounded-xl font-bold bg-primary text-background-dark transition-all duration-300 flex items-center justify-center gap-2 ${loading ? "opacity-50 cursor-not-allowed" : "hover:bg-emerald-400 hover:shadow-[0_0_20px_rgba(52,211,153,0.3)]"}`}>
						{loading ? (
							<>
